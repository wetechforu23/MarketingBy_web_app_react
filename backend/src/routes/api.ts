...
router.get('/clients', async (req, res) => {
  try {
    const result = await pool.query(
      'SELECT id, client_name, client_name as name, client_name as business_name, email, phone, contact_name as company, is_active as status, created_at FROM clients ORDER BY created_at DESC'
    );
